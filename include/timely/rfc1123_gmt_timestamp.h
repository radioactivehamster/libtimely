#ifndef TIMELY_RFC1123_GMT_TIMESTAMP_H
#define TIMELY_RFC1123_GMT_TIMESTAMP_H
...
static inline int timely_rfc1123_gmt_timestamp(char *restrict dest, const time_t *restrict timer)
{
